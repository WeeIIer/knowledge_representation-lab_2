...
class Ui_pp_editor_window(object):
    def setupUi(self, pp_editor_window):
        ...
        pp_editor_window.resize(961, 625)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 902, 354))
    ...
    def retranslateUi(self, pp_editor_window):
        ...
        self.groupBox.setTitle(_translate("pp_editor_window", "Основная информация"))
        ...
        self.group_output_attribute.setTitle(_translate("pp_editor_window", "Атрибут управления (TO ...)"))
