...
class Ui_pp_editor_window(object):
    def setupUi(self, pp_editor_window):
        ...
        pp_editor_window.resize(1050, 683)
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(pp_editor_window)
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(pp_editor_window)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_7 = QtWidgets.QGroupBox(pp_editor_window)
    ...
    def retranslateUi(self, pp_editor_window):
        ...
        self.groupBox.setTitle(_translate("pp_editor_window", "Лингвистическая переменная"))
        self.label_15.setText(_translate("pp_editor_window", "Название"))
        self.label_13.setText(_translate("pp_editor_window", "Минимум (ось X)"))
        self.label_14.setText(_translate("pp_editor_window", "Максимум (ось X)"))
        self.button_save.setText(_translate("pp_editor_window", "Сохранить"))
        self.groupBox_6.setTitle(_translate("pp_editor_window", "Термы"))
        self.label_12.setText(_translate("pp_editor_window", "Новый терм"))
        self.groupBox_3.setTitle(_translate("pp_editor_window", "Требования к виду функций принадлежности"))
        self.label.setText(_translate("pp_editor_window", "Требование к упорядоченности термов"))
        self.label_2.setText(_translate("pp_editor_window", "Требование к виду «крайних» функций принадлежности лингвистической переменной"))
        self.label_3.setText(_translate("pp_editor_window", "Требование к полноте покрытия предметной области"))
        self.label_4.setText(_translate("pp_editor_window", "Требование к разграничению понятий, описанных функциями принадлежности термов лингвистической переменной"))
        self.label_5.setText(_translate("pp_editor_window", "Требование к наличию типового элемента"))
        self.label_6.setText(_translate("pp_editor_window", "Требование к ограничению предметной шкалы"))
        self.groupBox_7.setTitle(_translate("pp_editor_window", "Редактирование верхних координат терма"))
        self.groupBox_2.setTitle(_translate("pp_editor_window", "График функций принадлежности"))
        self.groupBox_5.setTitle(_translate("pp_editor_window", "Редактирование нижных координат терма"))
