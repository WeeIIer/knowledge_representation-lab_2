...
class Ui_controller_window(object):
    def setupUi(self, controller_window):
        ...
        controller_window.resize(1118, 702)
        ...
        self.button_add_attribute = QtWidgets.QPushButton(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_3.addWidget(self.button_add_attribute)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 502, 357))
        ...
        self.button_add_output_attribute = QtWidgets.QPushButton(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.button_add_output_attribute.sizePolicy().hasHeightForWidth())
        self.button_add_output_attribute.setSizePolicy(sizePolicy)
        self.button_add_output_attribute.setMinimumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.button_add_output_attribute.setFont(font)
        self.button_add_output_attribute.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.button_add_output_attribute.setIconSize(QtCore.QSize(24, 24))
        self.button_add_output_attribute.setObjectName("button_add_output_attribute")
        self.verticalLayout_4.addWidget(self.button_add_output_attribute)
        ...
        self.verticalLayout.addLayout(self.layout_scroll_output_attribute)
        spacerItem2 = QtWidgets.QSpacerItem(20, 334, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.list_pp = QtWidgets.QListWidget(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.list_pp.sizePolicy().hasHeightForWidth())
        self.list_pp.setSizePolicy(sizePolicy)
        self.list_pp.setMinimumSize(QtCore.QSize(0, 0))
        self.list_pp.setMaximumSize(QtCore.QSize(16777215, 100))
        self.list_pp.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.list_pp.setObjectName("list_pp")
        self.verticalLayout_2.addWidget(self.list_pp)
    ...
    def retranslateUi(self, controller_window):
        ...
        self.button_add_attribute.setText(_translate("controller_window", "Добавить атрибут"))
        self.groupBox_4.setTitle(_translate("controller_window", "Атрибут управления (выход)"))
        self.button_add_output_attribute.setText(_translate("controller_window", "Добавить атрибут"))
        self.groupBox.setTitle(_translate("controller_window", "Подходящие продукционные правила"))
